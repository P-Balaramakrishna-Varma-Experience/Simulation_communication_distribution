...
Dir_test = Test/
objects_h = ${Dir_helper}hash_interface.o ${Dir_helper}KmerReader_FASTA.o ${Dir_helper}MurmurHash3.o ${Dir_helper}Polynomial_rolling.o ${Dir_helper}Read_FASTA.o ${Dir_helper}ClassicalMinimizer.o ${Dir_helper}supermer_reader.o ${Dir_helper}hash_table_dist.o ${Dir_helper}Mapping.o
objects_nh = ${Dir_comms}Hash_based.o ${Dir_comms}Min_based.o ${Dir_comms}Min_based_faster.o ${Dir_dist}Hash_based.o ${Dir_dist}Min_based.o ${Dir_dist}Min_based_up.o
...
Generate_executables: hash_based_comm_cost min_based_comm_cost hash_based_dist min_based_dist min_based_comm_fast min_based_dist_up
...
min_based_dist_up: ${objects_h} ${Dir_dist}Min_based_up.o
	$(CC) $(CFLAGS) $^ -o $@
	mv $@ Executables/
###############################################################
